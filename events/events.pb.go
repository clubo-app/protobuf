...
type FriendRequested struct {
	...
	UserId      string               `protobuf:"bytes,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	FriendId    string               `protobuf:"bytes,2,opt,name=friend_id,json=friendId,proto3" json:"friend_id,omitempty"`
	RequestedAt *timestamp.Timestamp `protobuf:"bytes,3,opt,name=requested_at,json=requestedAt,proto3" json:"requested_at,omitempty"`
}
...
func (x *FriendRequested) GetRequestedAt() *timestamp.Timestamp {
	if x != nil {
...
func (x *FriendCreated) GetAcceptedAt() *timestamp.Timestamp {
	if x != nil {
		return x.AcceptedAt
	}
	return nil
...
func (x *PartyFavorited) GetFavoritedAt() *timestamp.Timestamp {
	if x != nil {
...
type PartyUnfavorited struct {
	...
	UserId        string               `protobuf:"bytes,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	PartyId       string               `protobuf:"bytes,2,opt,name=party_id,json=partyId,proto3" json:"party_id,omitempty"`
	UnfavoritedAt *timestamp.Timestamp `protobuf:"bytes,3,opt,name=unfavorited_at,json=unfavoritedAt,proto3" json:"unfavorited_at,omitempty"`
}
...
func (x *PartyUnfavorited) GetUnfavoritedAt() *timestamp.Timestamp {
	if x != nil {
...
var file_events_events_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x88, 0x01, 0x0a, 0x0a, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74,
	0x65, 0x72, 0x65, 0x64, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	...
	0x22, 0x3c, 0x0a, 0x0e, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x55, 0x70, 0x64, 0x61, 0x74,
	0x65, 0x64, 0x12, 0x2a, 0x0a, 0x07, 0x70, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x70, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x2e, 0x50, 0x72,
	0x6f, 0x66, 0x69, 0x6c, 0x65, 0x52, 0x07, 0x70, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x22, 0xe0,
	0x02, 0x0a, 0x0c, 0x50, 0x61, 0x72, 0x74, 0x79, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x12,
	...
	0x67, 0x12, 0x18, 0x0a, 0x07, 0x67, 0x65, 0x6f, 0x68, 0x61, 0x73, 0x68, 0x18, 0x07, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x07, 0x67, 0x65, 0x6f, 0x68, 0x61, 0x73, 0x68, 0x12, 0x25, 0x0a, 0x0e, 0x73,
	...
	0x6f, 0x64, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x0a, 0x20, 0x01,
	...
	0x74, 0x22, 0xc6, 0x02, 0x0a, 0x0c, 0x50, 0x61, 0x72, 0x74, 0x79, 0x55, 0x70, 0x64, 0x61, 0x74,
	...
	0x52, 0x09, 0x73, 0x74, 0x61, 0x72, 0x74, 0x44, 0x61, 0x74, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x63,
	0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x5f, 0x61, 0x74, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x09, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x45, 0x0a, 0x0d, 0x46, 0x72,
...
var file_events_events_proto_goTypes = []interface{}{
	...
	(*FriendCreated)(nil),       // 6: events.FriendCreated
	(*PartyFavorited)(nil),      // 7: events.PartyFavorited
	(*PartyUnfavorited)(nil),    // 8: events.PartyUnfavorited
	(*profile.Profile)(nil),     // 9: profile.Profile
	(*timestamp.Timestamp)(nil), // 10: google.protobuf.Timestamp
}
var file_events_events_proto_depIdxs = []int32{
	9,  // 0: events.ProfileUpdated.profile:type_name -> profile.Profile
	10, // 1: events.FriendRequested.requested_at:type_name -> google.protobuf.Timestamp
	10, // 2: events.FriendCreated.accepted_at:type_name -> google.protobuf.Timestamp
	10, // 3: events.PartyFavorited.favorited_at:type_name -> google.protobuf.Timestamp
	10, // 4: events.PartyUnfavorited.unfavorited_at:type_name -> google.protobuf.Timestamp
